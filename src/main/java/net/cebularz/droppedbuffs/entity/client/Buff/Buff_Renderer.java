...
public class Buff_Renderer extends EntityRenderer<Buff_Entity> {
    ...
    public @NotNull ResourceLocation getTextureLocation(@NotNull Buff_Entity pEntity) {
        ...
        return ResourceLocation.fromNamespaceAndPath(DroppedBuffs.MOD_ID, "textures/entity/buffeffects/buffeffect_" + textureIndex + ".png");
    }
    ...
    public void render(Buff_Entity entity, float yaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferSource, int light) {
        ...
        int color2 = ColorConverter.convertToARGB(alpha,red,green,blue);
        model.renderToBuffer(poseStack, consumer, LightTexture.FULL_BRIGHT, OverlayTexture.NO_OVERLAY,color2);
        poseStack.popPose();
